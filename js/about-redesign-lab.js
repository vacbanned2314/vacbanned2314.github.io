(() => {
    ...
    const blueprintDetails = {
        ...
        estimate: ['icon-file-detail', 'Расчёт проекта', 'Смета и спецификация', 'Показываем состав оборудования и стоимость до начала работ.', 'Зафиксированная цена', 'Исключены'],
        ...
        service: ['icon-shield-check', 'После запуска', 'Гарантия и сервис', 'Даём 5 лет гарантии и принимаем аварийные заявки 24/7.', 'Защита по договору', 'Всегда на связи']
    };
